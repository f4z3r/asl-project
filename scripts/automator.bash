...
alias scp='scp -q -o StrictHostKeyChecking=no'
...
function pinger {
    ...
    for machine in client{1..3}; do
        ssh ${mw1_pub} "echo 'mw1 > ${machine}' >> mw1_ping.log; ping -t 5 -i 0.2 ${!machine} >> mw_1_ping.log &" &
        ssh ${mw2_pub} "echo 'mw2 > ${machine}' >> mw2_ping.log; ping -t 5 -i 0.2 ${!machine} >> mw_2_ping.log &" &
        sleep 6;
...
function benchmark_memcached {
    ...
    log_dir="~/Desktop/logs/benchmark_memcached(${mydate})"
    mkdir ${log_dir};
...
function benchmark_clients {
    ...
    mydate=$(date +%Y-%m-%d_%Hh%M);
    log_dir="~/Desktop/logs/benchmark_clients(${mydate})"
    mkdir ${log_dir};
...
function benchmark_1mw {
    ...
    mydate=$(date +%Y-%m-%d_%Hh%M);
    log_dir="~/Desktop/logs/benchmark_1mw(${mydate})"
    mkdir ${log_dir};
...
function benchmark_2mw {
    ...
    mydate=$(date +%Y-%m-%d_%Hh%M);
    log_dir="~/Desktop/logs/benchmark_2mw(${mydate})"
    mkdir ${log_dir};
...
function throughput_writes {
    ...
    mydate=$(date +%Y-%m-%d_%Hh%M);
    log_dir="~/Desktop/logs/throughput_writes(${mydate})"
    mkdir ${log_dir};
...
function get_and_multigets {
    ...
    mydate=$(date +%Y-%m-%d_%Hh%M);
    log_dir="~/Desktop/logs/get_and_multigets(${mydate})"
    mkdir ${log_dir};
            ...
            for workers in "${worker_list[@]}"; do
                ...
                for clients in "${client_list[@]}"; do
                    ...
                    for rep in "${repetitions[@]}"; do
                        ...
                        ssh ${client1_pub} "./memtier_benchmark-master/memtier_benchmark --server=${mw1} --port=${mw1_port} --clients=${clients} --threads=${threads} --ratio=0:${op} ${memtier_options} --multi-key-get=${multiget} &> client_1_1_${rep}.log" &
                        ssh ${client1_pub} "./memtier_benchmark-master/memtier_benchmark --server=${mw2} --port=${mw2_port} --clients=${clients} --threads=${threads} --ratio=0:${op} ${memtier_options} --multi-key-get=${multiget} &> client_1_2_${rep}.log" &
                        ssh ${client1_pub} "dstat -c -n -d -T 1 ${runtime} > dstat_client_1_${rep}.log &" &

                        ssh ${client2_pub} "./memtier_benchmark-master/memtier_benchmark --server=${mw1} --port=${mw1_port} --clients=${clients} --threads=${threads} --ratio=0:${op} ${memtier_options} --multi-key-get=${multiget} &> client_2_1_${rep}.log" &
                        ssh ${client2_pub} "./memtier_benchmark-master/memtier_benchmark --server=${mw2} --port=${mw2_port} --clients=${clients} --threads=${threads} --ratio=0:${op} ${memtier_options} --multi-key-get=${multiget} &> client_2_2_${rep}.log" &
                        ssh ${client2_pub} "dstat -c -n -d -T 1 ${runtime} > dstat_client_2_${rep}.log &" &

                        ssh ${client3_pub} "./memtier_benchmark-master/memtier_benchmark --server=${mw1} --port=${mw1_port} --clients=${clients} --threads=${threads} --ratio=0:${op} ${memtier_options} --multi-key-get=${multiget} &> client_3_1_${rep}.log" &
                        ssh ${client3_pub} "./memtier_benchmark-master/memtier_benchmark --server=${mw2} --port=${mw2_port} --clients=${clients} --threads=${threads} --ratio=0:${op} ${memtier_options} --multi-key-get=${multiget} &> client_3_2_${rep}.log" &
                        ssh ${client3_pub} "dstat -c -n -d -T 1 ${runtime} > dstat_client_3_${rep}.log &" &
